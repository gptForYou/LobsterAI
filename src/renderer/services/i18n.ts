...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    htmlShareViewHint: '打开链接，输入分享码查看',
    htmlShareSuccess: '分享成功',
    htmlShareSuccessMessage: '分享链接已生成，可在此复制链接和分享码。',
    htmlShareFailed: '分享失败',
    htmlShareManageDialogTitle: '分享设置',
    htmlShareExistingShareMessage: '此文件已分享。可复制链接和分享码，或更新当前分享。',
    ...
    htmlShareAvailabilityOpenHint: '打开后可通过分享链接和分享码访问。',
    ...
    htmlShareSubscriptionRequiredMessage:
      'HTML 分享需要有效订阅。开通后即可生成需分享码访问的分享链接。',
    htmlShareOpenSubscription: '去订阅',
    htmlShareUnavailableInProduction: 'HTML 分享功能暂不可用。',
  ...
  en: {
    ...
    htmlShareViewHint: 'Open the link and enter the share code to view',
    htmlShareSuccess: 'Share created',
    htmlShareSuccessMessage: 'The share link is ready. You can copy the link and code here.',
    htmlShareFailed: 'Share failed',
    htmlShareManageDialogTitle: 'Share settings',
    htmlShareExistingShareMessage: 'This file is already shared. Copy the link and code, or update the share.',
    ...
    htmlShareAvailabilityOpenHint: 'When open, people can access it with the link and code.',
    ...
    htmlShareSubscriptionRequiredMessage:
      'HTML sharing requires an active subscription. After subscribing, you can create a share-code protected link.',
    htmlShareOpenSubscription: 'View subscription',
    htmlShareUnavailableInProduction: 'HTML sharing is currently unavailable.',
