...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkPlanMode: '计划模式',
    coworkGoal: '目标',
    coworkGoalStart: '开始目标',
    coworkGoalPause: '暂停目标',
    coworkGoalResume: '继续目标',
    coworkGoalComplete: '完成目标',
    coworkGoalBlock: '标记阻塞',
    coworkGoalClear: '清除目标',
    coworkGoalObjectivePlaceholder: '输入这个会话要持续推进的目标',
    coworkGoalNotePlaceholder: '可选：补充状态说明',
  ...
  en: {
    ...
    coworkGoal: 'Goal',
    coworkGoalStart: 'Start goal',
    coworkGoalPause: 'Pause goal',
    coworkGoalResume: 'Resume goal',
    coworkGoalComplete: 'Complete goal',
    coworkGoalBlock: 'Mark blocked',
    coworkGoalClear: 'Clear goal',
    coworkGoalObjectivePlaceholder: 'Enter the objective to keep pursuing in this session',
    coworkGoalNotePlaceholder: 'Optional status note',
